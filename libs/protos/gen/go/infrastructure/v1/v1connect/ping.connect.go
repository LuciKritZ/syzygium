...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/LuciKritZ/syzygium/libs/protos/gen/go/infrastructure/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "infrastructure.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/infrastructure.v1.PingService/Ping"
)

// PingServiceClient is a client for the infrastructure.v1.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the infrastructure.v1.PingService service. By
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	pingServiceMethods := v1.File_infrastructure_v1_ping_proto.Services().ByName("PingService").Methods()
...
// Ping calls infrastructure.v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the infrastructure.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/infrastructure.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("infrastructure.v1.PingService.Ping is not implemented"))
}
